...
TASKS: dict[str, TaskConfig] = {
    ...
    "expert": TaskConfig(
        ...
        scenario_theme="disaster_and_conflict",
        max_steps=12,
        depot_inventory=SupplyLedger(water=18, food=15, medicine=11),
        vehicles=[
            VehicleTemplate(vehicle_id="van_1", capacity=3),
            VehicleTemplate(vehicle_id="van_2", capacity=3),
            VehicleTemplate(vehicle_id="truck_1", capacity=4),
            VehicleTemplate(vehicle_id="truck_2", capacity=5),
        ],
        zones=[
            ZoneTemplate(
                zone_id="trauma_center",
                ...
                checkpoint_delay=1,
                displaced_population=95,
                demand=SupplyLedger(medicine=5, water=3),
            ),
            ZoneTemplate(
                zone_id="border_shelter",
                display_name="Border Shelter",
                ...
                access_window_end=6,
                checkpoint_delay=1,
                displaced_population=240,
                demand=SupplyLedger(food=4, water=4, medicine=1),
            ),
            ZoneTemplate(
                zone_id="old_town",
                display_name="Old Town",
                ...
                route_reopens_at_step=3,
                displaced_population=180,
                demand=SupplyLedger(food=3, water=3, medicine=2),
            ),
            ZoneTemplate(
                zone_id="north_camp",
                display_name="North Camp",
                ...
                travel_time=3,
                route_risk_score=0.2,
                displaced_population=210,
                demand=SupplyLedger(food=3, water=4),
            ),
            ZoneTemplate(
                zone_id="river_crossing",
                display_name="River Crossing",
                ...
                deadline_step=7,
                travel_time=3,
                route_risk_score=0.55,
                conflict_affected=True,
                access_window_start=4,
                access_window_end=9,
                checkpoint_delay=1,
                route_reopens_at_step=5,
                displaced_population=120,
                demand=SupplyLedger(food=2, water=3, medicine=1),
            ),
            ZoneTemplate(
                zone_id="hill_corridor",
                display_name="Hill Corridor",
                priority=1,
                deadline_step=8,
                travel_time=4,
                route_risk_score=0.35,
                conflict_affected=True,
                access_window_start=3,
                access_window_end=10,
                checkpoint_delay=2,
                displaced_population=130,
                demand=SupplyLedger(food=2, water=2, medicine=1),
            ),
        ],
        prompt="Coordinate humanitarian aid across a multi-front disaster and conflict response, balancing urgent medicine, unstable access windows, convoy risk, and civilian displacement pressure.",
    ),
}
